...
export const metadata: Metadata = {
  ...
  description: 'Política de cookies do website Safemed. Saiba como utilizamos cookies.',
}
      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-8">
        ...
        <div className="prose prose-surface max-w-none">
          <p className="text-lg text-surface-500 leading-relaxed">
            Este website utiliza cookies para melhorar a experiência de navegação. Saiba mais sobre como os utilizamos.
          </p>

          <div className="mt-8 bg-surface-50 rounded-2xl p-8 text-center">
            <p className="text-surface-400 text-sm">
              Política de cookies detalhada em preparação.
            </p>
            <Link
              href="/contacto"
