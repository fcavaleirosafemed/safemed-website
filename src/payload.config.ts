...
// import { JobPositions } from './collections/JobPositions' // temporarily disabled to clean DB
// import { Visitors } from './collections/Visitors' // TODO: re-enable after DB migration

// Globals
import { SiteSettings } from './globals/SiteSettings'
import { Navigation } from './globals/Navigation'
// import { PageContent } from './globals/PageContent' // temporarily disabled to clean DB
...
export default buildConfig({
  ...
  collections: [
    ...
    Testimonials,
    TeamMembers,
    // JobPositions, // temporarily disabled to clean DB
    // Visitors, // TODO: re-enable after DB migration
  ],
  globals: [
    SiteSettings,
    Navigation,
    // PageContent, // temporarily disabled to clean DB
  ],
