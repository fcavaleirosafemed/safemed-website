      ...
      <div className="relative w-full max-w-7xl mx-auto px-6 lg:px-8 py-28 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="max-w-xl">
            ...
            {/* CTAs */}
            <div className="mt-10 flex flex-wrap items-center gap-5 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
              <Link
                href="/contacto"
            ...
            {/* Trust Stats */}
            <div className="mt-12 flex items-center gap-8 text-sm animate-fade-in-up" style={{ animationDelay: '550ms' }}>
          ...
          {/* Right Column: Dashboard Mockup + Chat Input */}
